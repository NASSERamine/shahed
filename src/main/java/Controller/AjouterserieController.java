...
public class AjouterserieController implements Initializable {
	...
	Producteur connectedproducer = Session.getConnectedProducer();
	  ...
	  @FXML
	    private TextField synopsisurlvidtext;

	    @FXML
	    private TextField Synopsittext1;

	    @FXML
	    private TextField Synopsittext11;
	    ...
	    @FXML
	    private TextField annedesortietext1;
	    ...
	    @FXML
	    void switchToSeason(ActionEvent event) throws IOException {
	...
	public void initialize(URL location, ResourceBundle resources) {
	    ...
	    public void hundelsavebuttn()throws IOException, SQLException {
	    	...
	    	String country = annedesortietext1.getText();
	    	String synopsistext= Synopsittext1.getText();
	    	String language = languagetext.getText();
	    	int nbre_saison= Integer.parseInt(Synopsittext11.getText());
	    	...
	    	if(mediaController.ajouterSerie(name, anne_sortie, language, country, imageurl, synopsistext, genre, nbre_saison, type, id_producteur)) {
